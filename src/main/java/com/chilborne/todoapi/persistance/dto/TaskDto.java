...
public class TaskDto {
    ...
    @Schema(name = "to_do_list_id")
    private long listId;

    @Schema(name = "date_time_made", description = "automatically generated on Task creation")
    ...
    @Schema(name = "date_time_finished", description = "automatically generated on Task Completion")
    @JsonFormat(pattern="dd-MM-yyyy HH:mm:ss")
    ...
    @Schema(description = "Task is automatically activated on Task creation")
